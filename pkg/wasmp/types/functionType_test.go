...
func TestNewFunctionType(t *testing.T) {
	...
	negativeTestCases := []test_utilities2.TestCaseError{
		...
		{bytes.NewReader([]byte{0x00, 0x04, 0x7F, 0x7E, 0x7D, 0x7C, 0x00}), errors.New("Error while reading type section. Expected 0x60 but got: 0")},
		{bytes.NewReader([]byte{0x60, 0x04, 0x7F, 0x7E, 0x7D, 0x7C}), errors.New("EOF")}}
